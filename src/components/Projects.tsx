...
const projects = [
  ...
  },
  {
    ...
    tags: ['React', 'TypeScript', 'Tailwindcss', 'API'],
    gradient: 'from-pink-500 to-rose-500',
    url: 'https://github.com/caico1418/heroes-app',
    icon: Smartphone,
    imageProject: '/heroes.png',
  },
  {
    id: 9,
    title: 'Calculator App',
    category: 'Mobile Application',
    description: 'Calculadora creada en react native',
    tags: ['React', 'TypeScript', 'Nativewind'],
    gradient: 'from-pink-500 to-rose-500',
    url: 'https://github.com/caico1418/appCalculator',
    icon: Smartphone,
    imageProject: '/calculadora.png',
  },
];
